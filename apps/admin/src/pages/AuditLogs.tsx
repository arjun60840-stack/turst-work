...
const initialLogs: AuditLog[] = [
  ...
  { id: 'LOG-8806', timestamp: 'Yesterday, 05:12:00 PM', action: 'ADMIN_LOGIN_SUCCESS', actor: 'Super Admin (admin@nexvion.demo)', entityType: 'Auth', entityId: 'Session JWT Created', details: 'Successful 2FA login from Chrome/Windows (NEXVION Admin Console)', ipAddress: '103.21.144.12', hash: 'ef2d127de37b942baad06145e54b0c61', status: 'success' },
];
