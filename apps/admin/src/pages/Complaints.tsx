            ...
            <div className="py-4 space-y-3 text-xs">
              ...
              <div className="p-3.5 bg-slate-900/40 rounded-2xl border border-slate-800">
                ...
                <p className="text-[11px] text-slate-400 leading-relaxed">
                  Under NEXVION Cooperative Guidelines, escrow funds are temporarily held. Arbitrators may release 50% to worker and refund 50% to client, or approve full release upon proof.
                </p>
              </div>
            </div>
