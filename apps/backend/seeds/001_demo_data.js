...
async function seed(knex) {
    ...
    const categories = [
        ...
        { id: (0, uuid_1.v4)(), name: 'Plumbing', icon: '🔧', description: 'Piping, leak repairs, bathroom fittings and drainage', is_active: true },
        { id: (0, uuid_1.v4)(), name: 'Carpentry', icon: '🪚', description: 'Woodwork, furniture repair, doors and windows framing', is_active: true },
        { id: (0, uuid_1.v4)(), name: 'Painting', icon: '🎨', description: 'Interior, exterior wall painting and surface polishing', is_active: true },
        { id: (0, uuid_1.v4)(), name: 'Masonry', icon: '🧱', description: 'Brickwork, tiling, plastering and concrete repairs', is_active: true },
        { id: (0, uuid_1.v4)(), name: 'Cleaning', icon: '🧹', description: 'Household deep cleaning, post-construction and sanitation', is_active: true },
        { id: (0, uuid_1.v4)(), name: 'Agriculture', icon: '🌾', description: 'Harvesting, irrigation, crop maintenance and farm labor', is_active: true },
        { id: (0, uuid_1.v4)(), name: 'Repair & Maintenance', icon: '🔨', description: 'General household and community equipment fixes', is_active: true },
        { id: (0, uuid_1.v4)(), name: 'Household Help', icon: '🏠', description: 'Domestic chores, elder assistance and general home aid', is_active: true },
        { id: (0, uuid_1.v4)(), name: 'Community Services', icon: '🤝', description: 'Public park upkeep, sanitation drives and community works', is_active: true },
        { id: (0, uuid_1.v4)(), name: 'Gardening', icon: '🌿', description: 'Lawn mowing, tree trimming and landscaping', is_active: true },
        { id: (0, uuid_1.v4)(), name: 'Construction', icon: '🏗️', description: 'Small-scale building, site labor and scaffolding', is_active: true },
    ];
    ...
    const demoCustomerId = (0, uuid_1.v4)();
    await knex('users').insert({
        id: demoCustomerId,
    ...
    const primeCustomerRecordId = (0, uuid_1.v4)();
    ...
    const demoWorkerId = (0, uuid_1.v4)();
    await knex('users').insert({
        id: demoWorkerId,
    ...
    const primeWorkerRecordId = (0, uuid_1.v4)();
    ...
    for (let i = 0; i < coopConfigs.length; i++) {
        ...
        const leaderUserId = (0, uuid_1.v4)();
        await knex('users').insert({
            id: leaderUserId,
            email: cfg.email,
            password_hash: demoPasswordHash,
    ...
    const createdWorkers = [{ id: primeWorkerRecordId, user_id: demoWorkerId, name: 'Rahul Kumar' }];
    ...
    const createdCustomers = [{ id: primeCustomerRecordId, user_id: demoCustomerId, name: 'Ananya Sharma' }];
